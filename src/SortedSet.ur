...
fun union [a] (_: ord a) (s1: set a) (s2: set a): set a = List.foldl insert s2 (toList s1)  (* in collision s1 prevales *)

fun difference [a] (_: ord a) (s1: set a) (s2: set a): set a = List.foldl delete s1 (toList s2)  (* s1 - s2 *)

fun intersection [a] (_: ord a) (s1: set a) (s2: set a): set a = let val common = List.filter (flip member s1) (toList s2)
